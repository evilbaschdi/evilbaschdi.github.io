            ...
            function (response) {
                $.each(
                    ...
                    function (i, repo) {
                        ...
                        const aBtnWavesEffectWavesLightGreyDarken4 = $('<a />').addClass('btn').addClass('waves-effect').addClass('waves-light').addClass('grey').addClass('darken-4').addClass('z-depth-5')
                            .attr('href', link)
                            .attr('target', '_blank')
                            .attr('rel', 'noopener')
                            .append(linkText);
